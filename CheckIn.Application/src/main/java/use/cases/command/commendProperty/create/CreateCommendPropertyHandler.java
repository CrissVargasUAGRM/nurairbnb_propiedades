...
@Component
public class CreateCommendPropertyHandler implements Command.Handler<CreateCommendPropertyCommand, CommendPropertyDTO> {
	...
	public CommendPropertyDTO handle(CreateCommendPropertyCommand command) {
		...
		try {
			commendProperty = commendPropertyFactory.createCommend(
