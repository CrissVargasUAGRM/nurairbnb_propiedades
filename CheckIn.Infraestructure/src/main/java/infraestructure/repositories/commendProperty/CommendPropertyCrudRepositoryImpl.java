...
public class CommendPropertyCrudRepositoryImpl implements ICommendPropertyRepository {
  ...
  @Override
  public List<CommendProperty> getByPropiedadId(UUID idPropiedad)
      throws BusinessRuleValidationException {
    List<CommendPropertyJpaModel> jpaModels =
        commendPropertyCrudRepository.findByPropertyId(idPropiedad);
